...
# tutoriales del Customer Journey Analytics {#tutorials}

+ [Información general sobre Customer Journey Analytics](overview.md)
+ Conceptos básicos del Customer Journey Analytics {#cja-basics}
...
+ Preparación y planificación de datos {#data-prep}
   + [Trabajo con datos](data-prep/working-with-data-in-cja.md)
...
+ Conexiones {#connections}
   + [Conectarse a fuentes de datos en Platform](connections/connecting-customer-journey-analytics-to-data-sources-in-platform.md)
   + [Conexión detalla la experiencia en CJA](connections/connections-details-experience-in-cja.md)
   + [Creación de conexiones y edición de experiencias](connections/cja-connections-creation-and-edit-experience.md)
   + [Añadir datos anteriores a una conexión existente](connections/add-past-data-to-an-existing-connection-in-cja.md)
...
+ Vistas de datos {#data-views}
   ...
   + [Configuración básica de las vistas de datos](data-views/basic-configuration-for-data-views.md)
   + [Configuración de componentes en vistas de datos](data-views/configuring-component-settings-in-data-views.md)
   + [Configuración del tipo de componente en las vistas de datos](data-views/component-type-settings-in-data-views.md)
   + [Formato de métricas en vistas de datos](data-views/formatting-metrics-in-data-views.md)
   + [Incluir o excluir valores de métricas en vistas de datos](data-views/include-or-exclude-metric-values-in-data-views.md)
   ...
   + [Incluir o excluir valores de dimensión en vistas de datos](data-views/include-or-exclude-dimension-values-in-data-views.md)
   + [Enlace de Dimension en vistas de datos](data-views/binding-dimensions-in-data-views.md)
   + [No configurar opciones de valor en las vistas de datos](data-views/configure-no-value-options-in-data-views.md)
   + [Configuración de atribución en vistas de datos](data-views/attribution-settings-in-data-views.md)
+ Visualizaciones {#visualizations}
   + [Creación de visualizaciones multicanal](visualizations/creating-cross-channel-visualizations-in-customer-journey-analytics.md)
...
+ Componentes {#components}
   + Filtros (segmentación) {#filters}
      ...
      + [Creación de filtros multicanal](components/filters/creating-cross-channel-filters-in-customer-journey-analytics.md)
...
+ Tableros (informes de valoración) {#dashboards}
   ...
   + Métricas calculadas {#calc-metrics}
      ...
      + [Mover las métricas calculadas de Adobe Analytics a Customer Journey Analytics](components/calc-metrics/moving-your-calculated-metrics-from-adobe-analytics-to-customer-journey-analytics.md)
...
+ Modelos {#blueprints}
   + [modelo del Customer Journey Analytics](https://experienceleague.adobe.com/docs/blueprints-learn/architecture/customer-journey-analytics/overview.html?lang=es)
   ...
   + [Caso de análisis de recorrido de deformación de llamadas](https://experienceleague.adobe.com/docs/blueprints-learn/architecture/customer-journey-analytics/call-deflect.html?lang=es#customer-journey-analytics)
