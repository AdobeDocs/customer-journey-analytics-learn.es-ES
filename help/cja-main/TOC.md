...
+ Servidor MCP remoto {#remote-mcp-server}
  + [Información general sobre el servidor MCP remoto para CJA](remote-mcp-server/remote-mcp-server-for-cja-overview.md)
  + [Servidor MCP remoto para CJA en acción](remote-mcp-server/remote-mcp-server-for-cja-in-action.md)
...
+ Conexiones {#connections}
  ...
  + [Sincronizar con el almacén de datos externo](connections/cja-data-mirror-sync-external-platforms.md)
  ...
  + [Introducción al análisis de audiencia](connections/get-started-with-audience-analysis.md)
+ Identificación de visitantes {#visitor-id}
  ...
  + [Validación de datos y calidad de vinculación mediante previsualización](visitor-id/validate-identity-stitching-quality.md)
  + [Configuración, habilitación y validación](visitor-id/stitching-enablement-and-validation.md)
...
+ Analysis Workspace {#analysis-workspace}
  ...
  + Tablas de forma libre {#freeform-tables}
    + [Uso de clasificaciones en línea](analysis-workspace/freeform-tables/in-line-classifications-for-cja.md)
    + [Explorar la configuración de filas y columnas en tablas de forma libre](analysis-workspace/freeform-tables/cja-explore-row-and-column-settings-in-freeform-tables.md)
  + Visualizaciones {#visualizations}
    ...
    + [Configuración de fuentes de datos de visualización y tabla](analysis-workspace/visualizations/cja-configure-table-and-visualization-data-source-settings.md)
    ...
    + [Adición de líneas de tendencia a las visualizaciones de líneas](analysis-workspace/visualizations/cja-add-trendlines-to-line-visualizations.md)
    + [Uso de la función media acumulativa para el suavizado de métricas](analysis-workspace/visualizations/cja-use-the-cumulative-average-function-for-metric-smoothing.md)
    + [Adición y configuración de la visualización de mapas](analysis-workspace/visualizations/configure-and-use-the-map-visualization.md)
    + [Agregar visualizaciones de resumen](analysis-workspace/visualizations/use-summary-visualizations.md)
    + [Añadir visualizaciones de texto](analysis-workspace/visualizations/add-text-visualizations.md)
    + [Vínculo dentro o fuera del proyecto](analysis-workspace/visualizations/cja-link-inside-or-outside-of-your-project.md)
    + [Añadir visualizaciones de dispersión](analysis-workspace/visualizations/use-scatterplot-visualizations.md)
    + [Adición de visualizaciones de mapas de árbol](analysis-workspace/visualizations/add-treemap-visualizations.md)
    + [Creación de visualizaciones apiladas al 100 %](analysis-workspace/visualizations/create-stacked-visualizations.md)
    + [Personalización de leyendas de visualización](analysis-workspace/visualizations/cja-customize-visualization-legends.md)
    + [Definir granularidad para visualizaciones](analysis-workspace/visualizations/cja-set-granularity-for-visualizations.md)
  ...
  + Depurar y compartir {#curate-and-share}
    + [Relato de datos: Generar presentaciones de diapositivas](analysis-workspace/curate-and-share/data-storytelling-generate-slides.md)
