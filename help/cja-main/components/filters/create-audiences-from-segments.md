...
# Crear públicos a partir de segmentos

Obtenga información sobre cómo crear y publicar públicos de Customer Journey Analytics en Real-Time Customer Data Platform. Este vídeo le guía a través del desarrollo de segmentos, la definición de frecuencias de actualización de audiencias y el aprovechamiento de perspectivas para campañas en Journey Optimizer o aplicaciones de terceros.
...
>[!VIDEO](https://video.tv.adobe.com/v/3471276/?captions=spa&learn=on)
