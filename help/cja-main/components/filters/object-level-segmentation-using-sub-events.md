---
title: Analizar subeventos para la segmentación de nivel de objeto en CJA
description: Descubra cómo el análisis de subeventos en Customer Journey Analytics permite la segmentación en el nivel de objeto, reduciendo la atribución excesiva y mejorando el análisis de ingresos.
feature: Segments
role: User
level: Intermediate
...
# Analizar subeventos para la segmentación de nivel de objeto en CJA
