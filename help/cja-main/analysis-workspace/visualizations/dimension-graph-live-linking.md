...
description: Al agregar o crear una visualización a partir de un valor de dimensión, puede seleccionar diferentes valores de dimensión y cambiar el gráfico dinámicamente o bloquear la visualización para permanecer en una dimensión o ubicación.
...
# Vinculación en directo de gráficos de Dimension en Analysis Workspace
